...
namespace Computer_Shop
{
    public partial class adminPanelForm : Form
    {
        ...
        proxyForm[] forms = new proxyForm[] { new newUserForm(), new newGiversForm(), new newOrderForm(), new newCancelForm(), new newBreakForm(), new newGainsForm(), new newRevisionForm(), new newGoodTypeForm(), new newGoodForm() };
        ...
        public adminPanelForm(string adminUser, string adminSurname)
        {
            InitializeComponent();
        ...
        private void adminPanelForm_Load(object sender, EventArgs e)
        {
            ...
            DataTable dataTable = dataBaseWorker.selectAllTable("Сотрудники");
