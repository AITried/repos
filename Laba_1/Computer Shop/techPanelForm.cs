...
{
    public partial class techPanelForm : Form
    {
        string adminSurname;
        string adminUser;
        DataBaseWorker dataBaseWorker = new DataBaseWorker();
        proxyForm[] forms = new proxyForm[] { new newOrderForm(), new newCancelForm(), new newBreakForm(), new newGainsForm(),  new newGoodForm() };
        ...
        public techPanelForm()
        {
            InitializeComponent();
        }

        public techPanelForm(string adminUser, string adminSurname)
        {
            InitializeComponent();
        ...
        private void techPanelForm_Load(object sender, EventArgs e)
        {
            ...
            DataTable dataTable = dataBaseWorker.selectAllTable("Заказы");
